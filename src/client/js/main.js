...
$(document).ready(function($){
	...
	var coursesSlider = $("#coursesSlider");
	...
	var coursesData = coursesSlider.data('owlCarousel');


	var exTgt = $('.courses-ctrl').find('.go');
	exTgt.on('click', function(e){
		e.preventDefault();
		if($(this).hasClass('go-left')){
			coursesData.prev();
	...
	var onlineCoursesSlider = $("#onlineCoursesSlider");
	...
	var onlineCoursesData = onlineCoursesSlider.data('owlCarousel');


	var exTgt = $('.online-courses-ctrl').find('.go');
	exTgt.on('click', function(e){
		e.preventDefault();
		if($(this).hasClass('go-left')){
			onlineCoursesData.prev();
		} else {
			onlineCoursesData.next();
		}
	});
